...
class AppLocalizationsBg extends AppLocalizations {
  ...
  String get faqChangeNotificationRadiusAnswer =>
      'Отидете в Настройки > Радиус за известия и регулирайте плъзгача. Можете да го зададете от 1 км до 50 км в зависимост от това колко далеч сте готови да помогнете.';
